...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['add'])) {
    ...
    // Tambahkan user_id dan action
    $user_id = $id; // dari session
    $action = "Tambah latihan"; // bisa disesuaikan
    
    $query = "INSERT INTO trackeradmin 
              (user_id, action, tanggal_latihan, exercise, sets, reps, weight, note) 
              VALUES 
              ('$user_id', '$action', '$tanggal', '$exercise', '$sets', '$reps', '$weight', '$note')";
...
if (isset($_GET['hapus'])) {
    ...
    mysqli_query($koneksi, "DELETE FROM trackeradmin WHERE id='$hapus_id'");
}

// === Ambil data ===
$trackers = mysqli_query($koneksi, "SELECT * FROM trackeradmin ORDER BY tanggal_latihan DESC");
?>
...
<head>
    ...
    <style>
        * {margin:0;padding:0;box-sizing:border-box;font-family:'Segoe UI',sans-serif;}
        ...
        .menu-btn {
            position:absolute;left:0.8rem;top:15px;
            width:16px;height:12px;display:flex;
        ...
        form input,form textarea,form button {
            ...
            border-radius:6px;border:none;outline:none;font-size:0.9rem;
        }
        form input,form textarea {background:rgba(255,255,255,0.9);color:#0f172a;}
        form button {
            background-color:#3b82f6;color:white;cursor:pointer;transition:0.3s;
        }
        ...
        a.hapus,a.edit {
            ...
            transition:0.3s;margin:0 3px;display:inline-block;
        }
...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <a href="trackeradmin.php" class="active">Tracker</a>
    ...
    <div class="main-content">
        ...
        <table>
            ...
            <?php if (mysqli_num_rows($trackers) > 0): ?>
                ...
                <?php endwhile; ?>
            <?php else: ?>
                <tr><td colspan="7" style="color:#94a3b8;">Belum ada latihan yang ditambahkan.</td></tr>
            <?php endif; ?>
        </table>
