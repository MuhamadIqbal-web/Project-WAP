...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['add'])) {
    ...
    $query = "INSERT INTO tracker 
              (user_id, tanggal_latihan, exercise, sets, reps, weight, note) 
              VALUES 
              ('$user_id', '$tanggal', '$exercise', '$sets', '$reps', '$weight', '$note')";
...
if (isset($_GET['hapus'])) {
    ...
    mysqli_query($koneksi, "DELETE FROM tracker WHERE id='$hapus_id'");
}

// === Ambil data ===
$trackers = mysqli_query($koneksi, "SELECT * FROM tracker ORDER BY tanggal_latihan DESC");
?>
